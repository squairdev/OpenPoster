...
class ExportOptionsDialog(QDialog):
    ...
    def init_ui(self):
        ...
        copy_btn.setIcon(QIcon(":/icons/export.svg"))
        ...
        copy_btn.setStyleSheet(f"border:2px solid {border_color};border-radius:15px;")
        copy_btn.clicked.connect(lambda: self.select('copy'))
        options_layout.addWidget(copy_btn)
        tendies_btn = QToolButton(self)
        tendies_btn.setIcon(QIcon(":/icons/export.svg"))
        ...
        tendies_btn.setStyleSheet(f"border:2px solid {border_color};border-radius:15px;")
        ...
        nugget_btn.setStyleSheet(f"border:2px solid {border_color};border-radius:15px;")
